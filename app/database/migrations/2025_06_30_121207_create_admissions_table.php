...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable(TableNames::Admissions->value)) {
            Schema::create(TableNames::Admissions->value, function (Blueprint $table) {
                $table->id('ID');
    ...
    {
        Schema::dropIfExists(TableNames::Admissions->value);
    }
};
